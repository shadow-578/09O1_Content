...
CreateConVar("ttt_sandwich_count", 2, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "How many sandwiches should be bought")
CreateConVar("ttt_sandwich_restore", 20, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "How many hp one sandwich should restore")
...
SWEP.Primary.ClipSize = GetConVar("ttt_sandwich_count"):GetInt()
SWEP.Primary.DefaultClip = GetConVar("ttt_sandwich_count"):GetInt()

SWEP.HealAmount = GetConVar("ttt_sandwich_restore"):GetInt()
