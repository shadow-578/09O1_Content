...
if ( CLIENT ) then
  SWEP.Base				= "weapon_tttbase"
	SWEP.PrintName			= "Finn's Sword of Truth"	//Name of the SWEP
	...
	killicon.AddFont("4D sword", "CSKillIcons", SWEP.IconLetter, Color( 255, 80, 0, 255 ))	//Sexy KillIcon. Too bad I don't know how to make a custom one work.
...
SWEP.Category				= "Adventure Time" //Where the SWEP is in the spawn menu.
...
SWEP.Primary.Damage			= 100	//Don't touch this, instead goto line 144.
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/4dsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, -7), angle = Angle(180, 90, 0), size = Vector(1.149, 1.149, 1.149), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
//WElements puts the scythe on the world model, so others see it.
SWEP.VElements = {
	["scythe"] = { type = "Model", model = "models/4dsword.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0,0, 7), angle = Angle(0, 0, 0), size = Vector(1.149, 1.149, 1.149), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
